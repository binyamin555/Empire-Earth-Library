...
#define EELIBRARY_VERSION_STRING STRINGIFY_MACRO(EELIBRARY_VERSION_MAJOR) "." STRINGIFY_MACRO(EELIBRARY_VERSION_MINOR) "." STRINGIFY_MACRO(EELIBRARY_VERSION_PATCH)
#define EELIBRARY_LAST_COMPATIBLE_VERSION_STRING STRINGIFY_MACRO(EELIBRARY_LAST_COMPATIBLE_VERSION_MAJOR) "." STRINGIFY_MACRO(EELIBRARY_LAST_COMPATIBLE_VERSION_MINOR) "." STRINGIFY_MACRO(EELIBRARY_LAST_COMPATIBLE_VERSION_PATCH)
